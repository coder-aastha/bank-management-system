...
# label_img = Label(logo,image=bank_img).grid(row=0,column=0)
...
#the 
heading= Label(frame,text='UPDATE ID', fg='#57a1f8',bg='white',font=('Microsoft YaHei UI Light', 20, 'bold'))
heading.grid(row=0,column=0)

Information= Label(frame,text='Update Information', fg='#57a1f8',bg='white',font=('Microsoft YaHei UI Light', 15, 'bold'))
Information.grid(row=1,column=0)

#refresh symbol
refresh = Label(frame, text="⟳", fg='#57a1f8',bg='white',font=('Microsoft YaHei UI Light', 15, 'bold'))
refresh.grid(row=0,column=1, pady=10, ipadx=5)
...
# #button for sign in
update= Button(frame, width=20,background='#3cdfff', text='update',border=0, bg='#3cdfff', cursor='hand2', fg='white')
